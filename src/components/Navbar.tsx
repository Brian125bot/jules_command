...
import { Target, CheckSquare, Play, ShieldAlert, FileText, Settings, RefreshCw } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] uppercase font-bold px-2 py-0.5 rounded border tracking-tight bg-emerald-950 text-emerald-400 border-emerald-800/80">
                  Live
                </span>
              </div>
